...
func CreateTestEnv(t *testing.T) (Keeper, sdk.Context, TestKeepers) {
	...
	k := NewKeeper(marshaler, peggyKey, paramsKeeper.Subspace(types.DefaultParamspace), stakingKeeper, bankKeeper, oraclekeeper.Keeper{})
	k.setParams(ctx, &types.Params{
		StartThreshold: 0,
		MinterAddress:  "Mx8858eeb3dfffa017d4bce9801d340d36cf895ccf",
		BridgeChainId:  11,
	})
...
func MintVouchersFromAir(t *testing.T, ctx sdk.Context, k Keeper, dest sdk.AccAddress, amount types.MinterCoin) sdk.Coin {
	coin := amount.PeggyCoin(ctx, k.oracleKeeper)
